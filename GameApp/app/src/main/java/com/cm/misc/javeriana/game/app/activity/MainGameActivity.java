...
import com.cm.misc.javeriana.game.app.adapter.CustomListAdapter;
...
public class MainGameActivity extends AppCompatActivity {
        ...
        butMGACheckNumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Log.e("MainGameActivity", "Error trying validate attempt", e);
    ...
    private void updateHistory() {
        ...
        listView.setAdapter(
                new CustomListAdapter(this, guessController.getGameHistoryDetails()));
    }
