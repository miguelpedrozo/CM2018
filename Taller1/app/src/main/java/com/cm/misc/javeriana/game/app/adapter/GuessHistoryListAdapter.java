 ...
 */
public class GuessHistoryListAdapter extends BaseAdapter {

    private ArrayList<GameHistoryDetail> listData;
    private LayoutInflater layoutInflater;

    /**
     * Constructor. Creates a new instance of {@link GuessHistoryListAdapter}
     *
     * @param context  the {@link View} context
     * @param listData an {@link ArrayList} with {@link GameHistoryDetail} objects
     */
    public GuessHistoryListAdapter(Context context, ArrayList<GameHistoryDetail> listData) {
    ...
    public View getView(int index, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.guess_game_history_list_item, null);
